...
namespace Model.implem
{
    public class HitBox : IHitBox
    {
        ...
        public IInterPoint CollisionFacette(IRay ray,int pos)
        {
            ...
            // R�cup�re les point de la facette
            List<ICoord3D> pointsFacette = GetFacette(pos);

            // Calcul le vecteur normal � la facette
            ...
            if (d != 0.0)
            {
                ...
                // Il faut maintenant v�rifier que le point est bien a l'interieur de la facette

                // On se trouve dans le rep�re local
                // IL suffit donc v�firier les coordonn� avec la valeurs min et max
